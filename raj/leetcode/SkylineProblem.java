...
public class SkylineProblem {
    ...
    public List<int[]> getSkyline(int[][] a) {
        ...
        /*
         * We should not use TreeSet also because. When there are duplicates, and when we are removing elements from
         * TreeSet it deletes all duplicates. Instead if we use map we can reduce count one by one
         */
