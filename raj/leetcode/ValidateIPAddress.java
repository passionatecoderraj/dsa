 ...
 *         code. For n-bytes character, the first n-bits are all one's, the n+1
 *         bit is 0, followed by n-1 bytes with most significant 2 bits being
 ...
 *         0000-0010 FFFF | 11110xxx 10xxxxxx 10xxxxxx 10xxxxxx Given an array
 *         of integers representing the data, return whether it is a valid utf-8
 *         encoding.
 * 
 ...
 *         followed by a 1-byte character. Example 2:
 * 
...
public class ValidateIPAddress {
	...
	public static void main(String[] args) {
		...
		String res = "";
		res = obj.validIPAddress("172.16.254.1");
		System.out.println(res);
		res = obj.validIPAddress("2001:0db8:85a3:0:0:8A2E:0370:7334");
		System.out.println(res);
		res = obj.validIPAddress("256.256.256.256");
		System.out.println(res);
