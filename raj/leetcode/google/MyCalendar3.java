...
public class MyCalendar3 {
	...
	// https://leetcode.com/articles/my-calendar-iii/
	// Time : O(n)
	...
	public static void main(String... args) {
		...
		result = obj.book(10, 20); // returns 1
		System.out.println(result);
		result = obj.book(50, 60); // returns 1
		System.out.println(result);
		result = obj.book(10, 40); // returns 2
		System.out.println(result);
		result = obj.book(5, 15); // returns 3
		System.out.println(result);
		result = obj.book(5, 10); // returns 3
		System.out.println(result);
		result = obj.book(25, 55); // returns 3
		System.out.println(result);
	}
}
