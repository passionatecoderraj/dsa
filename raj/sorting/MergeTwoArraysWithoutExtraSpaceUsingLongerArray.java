 ...
 */
public class MergeTwoArraysWithoutExtraSpaceUsingLongerArray {
	...
	public static void main(String[] args) {
		...
		MergeTwoArraysWithoutExtraSpaceUsingLongerArray obj = new MergeTwoArraysWithoutExtraSpaceUsingLongerArray();
